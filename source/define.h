...
define P_MAX_SHOT		= 10;
define_f PI				= 3.141592653589793f;
define FIELD_MIN_X		= 32;
define FIELD_MIN_Y		= 32;
define FIELD_MAX_X		= 416;
define FIELD_MAX_Y		= 448;
define FIELD_CENTER_X	= 224;
define FIELD_CENTER_Y	= 208;
define BULLET_KIND		= 253;
define ENEMY_MAX		= 50;
define DEFAULT_BOMB		= 4;
